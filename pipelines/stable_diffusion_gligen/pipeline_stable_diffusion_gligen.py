...
class StableDiffusionGLIGENPipeline(DiffusionPipeline):
    ...
    def set_fuser_current_timestep(self, current_timestep):
        ...
        for module in self.unet.modules():
            ...
            if module._get_name() == "GatedSelfAttentionDense":
                # print(f"set current_timestep: module={module._get_name()} | timestep={current_timestep}")
    ...
    def enable_fuser(
            self, 
            # enabled = True,
            enable_down_blocks = [0, 1, 2, 3],      # ADD: enable specific unet blocks/layers
            enable_mid_block = True,             # down_blocks: 3 layers, mid_block: 1 layer, up_blocks: 3 layers
            enable_up_blocks = [0, 1, 2, 3],
